            ...
            onEnter: function (args) {
                ...
                if (fileName.endsWith(moduleName)) {
                    ...
                    }
                    {
                        ...
                        var refreshAddr = Module.findExportByName(moduleName, '_ZN4mt247UILayer17refreshHeroStatusEv')
                        var schedulerAddr = Module.findExportByName(moduleName, '_ZN7cocos2d9SchedulerC2Ev')
                        var refreshFunc= new NativeFunction(refreshAddr, "int", ["pointer"])
                            ...
                            setInterval(function(){
                                ...
                                if(playerBaseMT24!=null){
    
                                    console.log('mod mt24')
                                    ...
                                    refreshFunc(Memory.readPointer( playerBaseMT24.add(0xc)))
